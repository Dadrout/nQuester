    ...
    def create_default_quests(self):
        ...
        self.quests_data = {
            ...
            "quest_shoqan_01": {
                "id": "quest_shoqan_01",
                "npc_id": "Shoqan",
                "title": "Mobile Debug Master",
                "dialogue_start": [
                    "Мобильное приложение крашится.",
                    "Отлади Android/iOS код!"
                ],
                "dialogue_complete": "Приложение стабильно! Mobile dev на высоте!",
                "user_feedback": [
                    "📱 Приложение больше не крашится! Спасибо!",
                    "Mobile приложение работает идеально! Отличная работа!",
                    "Настоящий мобильный эксперт! Приложение спасено!"
                ],
                "type": "minigame",
                "minigame_id": "mobile_debug",
                "reward": {"users": 450, "item": "Mobile Certificate"}
            },
            "quest_zhasulan_01": {
